...
CREATE TABLE public.employees (
    ...
    email text,
    CONSTRAINT employees_email_check CHECK ((email ~* '^(([^<>()\[\]\\.,;:\s@\"]+(\.[^<>()\[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$'::text))
);
...
CREATE TABLE public.shippers (
    ...
    company_name character varying(40) NOT NULL,
    phone character varying(24),
    CONSTRAINT shippers_company_name_check CHECK (((company_name)::text <> ''::text)),
    CONSTRAINT shippers_phone_check CHECK (((phone)::text ~* '(^\+1[0-9]{10}$)|(^[0-9]{5}$)|(^MG([A-z]|[0-9]){32}$)'::text))
);
...
1897d74f-759d-44f9-a548-f82c21d4de88	097eb4f194cdae4d9d4726415767095afb0eeaf8155277a49dd9f7fd786bdd43	2023-08-03 18:53:49.885793-07	0_init		\N	2023-08-03 18:53:49.885793-07	0
\.
...
9	Dodsworth	Anne	Sales Representative	Ms.	1966-01-27	1994-11-15	7 Houndstooth Rd.	London	\N	WG2 7LT	UK	(71) 555-4444	452	Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.	5	http://accweb/emmployees/davolio.bmp	9@trpc.invalid
\.
...
COPY public.shippers (id, company_name, phone) FROM stdin;
6	DHL	+18002255345
5	UPS	+18007827892
4	Alliance Shippers	+18002220451
3	Federal Shipping	+15035559931
2	United Package	+15035553199
1	Speedy Express	+15035559831
3162	Scott	+16025381318
\.
...
SELECT pg_catalog.setval('public.shippers_id_seq', 3168, true);
...
--
-- Name: shippers_company_name_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX shippers_company_name_key ON public.shippers USING btree (company_name);
...
ALTER TABLE ONLY public.orders
    ADD CONSTRAINT fk_orders_shippers FOREIGN KEY (ship_via) REFERENCES public.shippers(id);
